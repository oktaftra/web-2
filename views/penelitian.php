...
$list_Penelitian=$penelitian->index();

if (isset($_POST['type'])) {
    if ($_POST['type'] == 'delete') {
        $row = $penelitian->delete($_POST['id']);
...
<div class="container">
    <div class="card">
        <div class="card-body">
            <div class="mb-2">
                <a class="btn btn-success btn-sm" href="?url=penelitian-input">
                    Tambah penelitian
                </a>
            </div>
                ...
                <tbody>
                    ...
                    foreach ($list_Penelitian as $row): ?>
                        <tr>
                            ...
                            <td><?= $row['bidang_ilmu_id'] ?></td>
                            <td>
                                <div class="d-flex">
                                    <a href="?url=penelitian-input&id=<?= $row['id'] ?>"
